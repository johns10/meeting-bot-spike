...
def transcribe(file_path):
    ...
    diarize_model = whisperx.DiarizationPipeline(
        use_auth_token="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", device=device
    )
...
def main():
    parser = argparse.ArgumentParser(description="Transcription Application")
    parser.add_argument(
        "-p", "--path", type=str, required=True, help="Input file for transcription"
    )
